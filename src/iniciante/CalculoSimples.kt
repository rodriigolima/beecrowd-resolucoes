...
fun main(args: Array<String>) {
    ...
    val cod1: Int = entrada.nextInt()
    val num1: Double = entrada.nextDouble()
    val valor1: Double = entrada.nextDouble()

    val cod2: Int = entrada.nextInt()
    val num2: Double = entrada.nextDouble()
    val valor2: Double = entrada.nextDouble()

    val valorTotal: Double = num1 * valor1 + num2 * valor2

    println("VALOR A PAGAR: R$ ${String.format("%.2f", valorTotal)}")
}