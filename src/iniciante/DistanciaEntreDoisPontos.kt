...
fun main(args: Array<String>) {
    ...
    val x1: Double = entrada.nextDouble()
    val y1: Double = entrada.nextDouble()
    val x2: Double = entrada.nextDouble()
    val y2: Double = entrada.nextDouble()

    val distancia: Double = sqrt((x2 - x1).pow(2.0) + (y2 - y1).pow(2.0))
