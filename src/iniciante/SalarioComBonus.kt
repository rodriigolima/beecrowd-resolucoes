...
dupla precisão (double) com duas casas decimais, representando o salário
...
fun main(args: Array<String>) {
    ...
    val nome: String = entrada.next()
    val salarioFixo: Double = entrada.nextDouble()
    val bonus: Double = entrada.nextDouble()

    val salarioComBonus: Double = bonus * 15 / 100 + salarioFixo

    println("TOTAL = R$ ${String.format("%.2f", salarioComBonus)}")
}